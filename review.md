...
Deadline for submission after fixes: 17 August, 2026 (Two weeks)
...
(2) The evaluation provides a proof of concept. It will be good to see how the system deals with (1) multiple trains with potential conflicts and (2) more complicated network conditions, although the reviewer understands that it is not the focus of this paper.
...
Comments to the Author
The following comments are suggestions rather than mandatory revisions.
I hope the authors may consider them to further improve the manuscript.
